...
export default function TentangAplikasi({ onClose }: TentangProps) {
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
      ...
      >
        <Card className="bg-white rounded-[32px] border-4 border-purple-300 shadow-2xl p-6 md:p-8 relative flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-6 mt-2">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-black text-purple-950 tracking-tight">
                Tentang Aplikasi
              </h3>
          ...
          <div className="text-base md:text-lg text-slate-700 leading-relaxed overflow-y-auto max-h-[60vh] pr-2 space-y-6 font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-amber-50 border border-amber-100 flex gap-3">
                ...
                <div>
                  <h5 className="font-black text-amber-950 text-sm md:text-base">Visual Kontras & Jelas</h5>
              ...
              <div className="p-4 rounded-2xl bg-blue-50 border border-blue-100 flex gap-3">
                ...
                <div>
                  <h5 className="font-black text-blue-950 text-sm md:text-base">Pengisi Suara Kustom</h5>
                  <p className="text-xs md:text-sm text-slate-600 mt-1 font-medium">
              ...
              <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-100 flex gap-3">
                <span className="text-2xl shrink-0">🎈</span>
                <div>
                  <h5 className="font-black text-emerald-950 text-sm md:text-base">Stimulasi Motorik Halus</h5>
                  <p className="text-xs md:text-sm text-slate-600 mt-1 font-medium">
              ...
              <div className="p-4 rounded-2xl bg-rose-50 border border-rose-100 flex gap-3">
                <span className="text-2xl shrink-0">💖</span>
                <div>
                  <h5 className="font-black text-rose-950 text-sm md:text-base">Aman & Bebas Gangguan</h5>
                  <p className="text-xs md:text-sm text-slate-600 mt-1 font-medium">
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-bold bg-purple-100 text-purple-700">
