      ...
      {!quizFinished ? (
        <div className="w-full flex flex-col items-center">
          ...
          <Button
            ...
            variant="outline"
            className="btn-tactile mb-6 py-5 px-6 bg-sky-100 hover:bg-sky-200 border-2 border-sky-300 rounded-[20px] text-sky-800 font-extrabold flex items-center gap-2 cursor-pointer shadow-sm text-sm h-auto"
          >
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <Button
                  ...
                  variant="ghost"
                  className="btn-tactile p-6 bg-yellow-100 hover:bg-yellow-200 border-4 border-yellow-300 rounded-3xl text-2xl font-black text-yellow-800 cursor-pointer h-32 w-full"
                >
                  🟡 KUNING
                </Button>
                <Button
                  ...
                  variant="ghost"
                  className="btn-tactile p-6 bg-red-100 hover:bg-red-200 border-4 border-red-300 rounded-3xl text-2xl font-black text-red-800 cursor-pointer h-32 w-full"
                >
                  🔴 MERAH
                </Button>
              </div>
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <Button
                  onClick={() => handleQuizAnswer(false)}
                  variant="ghost"
                  className="relative btn-tactile p-4 bg-slate-50 hover:bg-slate-100 border-4 border-slate-200 rounded-3xl flex justify-center items-center h-40 cursor-pointer w-full"
                >
                  <Image
                    src={round}
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="grid grid-cols-3 gap-4 w-full">
                <Button
                  onClick={() => handleQuizAnswer(false)}
                  variant="ghost"
                  className="btn-tactile p-6 bg-sky-50 hover:bg-sky-100 border-4 border-sky-200 rounded-3xl text-4xl font-black text-sky-700 cursor-pointer w-full h-auto"
                >
                  1
                </Button>
                <Button
