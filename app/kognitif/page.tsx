...
export default function KognitifSubmenuPage() {
  ...
  const items = [
    { href: "/kognitif/mengenal-warna", key: "warna", title: "Mengenal Warna 🎨", tts: "Mulai bermain warna" },
    { href: "/kognitif/mengenal-bentuk", key: "bentuk", title: "Mengenal Bentuk 📐", tts: "Mulai mengenal bentuk" },
    { href: "/kognitif/belajar-berhitung", key: "angka", title: "Belajar Berhitung 🔢", tts: "Mulai belajar berhitung angka" }
  ];
